...
## Build Image for Production (Default)

Run `docker build -t belajar-angular:prod .` 

## Build Image for Dev

Run `docker build -t belajar-angular:dev . --build-arg configuration=""` 

## Run Image

Run `docker run -p 80:80 belajar-angular:prod`
